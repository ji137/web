...
<div id="main-container" class="container">
    ...
    <div class="" style="margin-top:50px;">
        <!-- Contents
        ================================================== -->
    <div class="certimg search-form">
      <span>单据号：</span><input type="text" value="" name="dh" value="<?php echo I('dh');?>" placeholder="输入销售单号"/>
      <span>批号：</span><input type="text" 
       name="ph" value="<?php echo I('ph');?>" placeholder="输入查询批号"/>
      </label>
       <button class="btn find" url="<?php echo U('Certimg/index');?>" >查询</button>
    </div>
		...
		<table>
            ...
            <tbody>
                <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><a href="<?php echo U('Certimg/detail','id='.$data['id']);?>"><?php echo ($data["spmch"]); ?></a></td>
                      <td><?php echo ($data["shengccj"]); ?></td>
                      <td><?php echo ($data["pihao"]); ?></td>
                      <td><?php echo ($data["sl"]); ?></td>
                      <td><?php echo ($data["pizhwh"]); ?></td>
                      <td><?php echo ($data["kpman"]); ?></td>
