...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Public/Admin/css/login.css?111" media="all">
       	<link rel="stylesheet" type="text/css" href="/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/Public/static/slideunlock/slideunlock.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/Public/static/slideunlock/slideunlock.js" media="all">
    </head>
    ...
    <body id="login-page" >
           <div class="head_box">
                <div class="inner wrp">
                    <h1 class="logo">
                        <a href="/" title="恩华和润"> 
                        <img style="height:40px;" src="/Public/logo.png" /></a>
                    </h1>
                </div>
        </div>
                ...
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        ...
                        <div id="itemBox" class="item-box">
                           ...
                           <?php if(C('SHOW_VERIFY')): ?><div class="item verifycode">
    ...
    <script type="text/javascript" src="/Public/static/slideunlock/slideunlock.js"></script>
    <!--<![endif]-->
