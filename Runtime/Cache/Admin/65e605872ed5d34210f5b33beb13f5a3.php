...
<body>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('edit','id='.$vo['uid']);?>"><?php echo ($vo["nickname"]); ?></a></td>
			<td><?php echo ($vo["businessid"]); ?></td>
			<td><?php echo ($vo["login"]); ?></td>
			<td><span><?php echo ($vo["time_begin"]); ?></span></td>
			<td><span><?php echo ($vo["time_end"]); ?></span></td>
